...
st.markdown("""
    ...
    /* Premium Top Metrics Grid (Red / Green / Blue KPI Cards) */
...
try:
    ...
    # ==========================================
        ...
        # 🔴 ΕΠΑΝΑΦΟΡΑ ΤΩΝ ΑΡΧΙΚΩΝ KPI CARDS (ΜΕ ΤΑ ΣΩΣΤΑ ΧΡΩΜΑΤΑ ΚΑΙ ΠΟΣΑ)
        st.markdown(f"""
        ...
        # 🔴 ΕΠΑΝΑΦΟΡΑ ΤΟΥ ΣΤΡΑΤΗΓΙΚΟΥ ΠΛΑΙΣΙΟΥ "REASON FOR INTERNAL MOVEMENTS" (ΟΠΩΣ ΣΤΟ SPREADSHEET)
        st.markdown("""
